...
public class sendfiles extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set = findViewById(R.id.imageView5);
        send = findViewById(R.id.imageView4);
        home = findViewById(R.id.reset);
            ...
            ref.putFile(fileuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    runOnUiThread(new Runnable() {
                        public void run()
                        {
                            Toast.makeText(sendfiles.this, "Files uploaded to server, wait while checking the connection ! ", Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        okhttpclient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                runOnUiThread(new Runnable() {
                    public void run()
                    {
                        Toast.makeText(sendfiles.this, "Server authentication failed!", Toast.LENGTH_SHORT).show();
                    }
                });
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                if (result.verified) {
                    runOnUiThread(new Runnable() {
                        public void run()
                        {
                            Toast.makeText(sendfiles.this, "Downloading to the server!", Toast.LENGTH_SHORT).show();
                        }
                    });
                    ...
                    runOnUiThread(new Runnable() {
                        public void run()
                        {
                            Toast.makeText(sendfiles.this, "Server verification faild!", Toast.LENGTH_SHORT).show();
                        }
                    });
        ...
        okhttpclient.newCall(request).enqueue(new Callback() {
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    public void run()
                    {
                        Toast.makeText(sendfiles.this, "Server error!", Toast.LENGTH_SHORT).show();
                    }
                });
            }
            ...
            public void onResponse(Call call, Response response) throws IOException {
                runOnUiThread(new Runnable() {
                    public void run()
                    {
                        Toast.makeText(sendfiles.this, "File uploaded successfully!", Toast.LENGTH_SHORT).show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 100 && resultCode == RESULT_OK && data != null) {
            ...
            runOnUiThread(new Runnable() {
                public void run()
                {
                    Toast.makeText(sendfiles.this,"File selected successfully",Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
