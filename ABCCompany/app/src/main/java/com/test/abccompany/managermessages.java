...
public class managermessages extends AppCompatActivity {

    OkHttpClient okhttpclient, okhttpclient2;
    TextView messages;
    String responses = "", secret = "M5SO8Gt0X9UHSg5YpThB0nG7hXsrpQ2v", bcryptHashString;
    Request request;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String checker = messageInput + secret;
                ...
                okhttpclient.newCall(request).enqueue(new Callback() {
                    ...
                    public void onFailure(@NonNull Call call, @NonNull IOException e) {
                        runOnUiThread(new Runnable() {
                            public void run()
                            {
                                Toast.makeText(managermessages.this, "Back end Server error!", Toast.LENGTH_SHORT).show();
                            }
                        });
                    ...
                    public void onResponse(@NonNull Call call, @NonNull Response response) throws IOException {
                        ...
                        runOnUiThread(new Runnable() {
                            public void run()
                            {
                                Toast.makeText(managermessages.this,"Message Sent Successfully!",Toast.LENGTH_SHORT).show();
                            }
                        });
