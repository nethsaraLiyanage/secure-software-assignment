...
public class loginaltworker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loginaltworker);
        ...
        if (uN.matches("") || pW.matches("")){
            ...
            okhttpclient.newCall(request).enqueue(new Callback() {
                ...
                public void onFailure(@NonNull Call call, @NonNull IOException e) {
                    Toast.makeText(loginaltworker.this,"Back end Server error!",Toast.LENGTH_SHORT).show();
